...
if __name__ == '__main__':
    ...
    # 생성된 이미지 디렉토리 경로 설정
    directory_path = '/home/jwjang/project/cyclegan_pix2pix_pr/2step/CycleGAN-and-pix2pix/results/maps_cyclegan/test_latest/images'
    # 원본 이미지 디렉토리 경로 설정
    ...
    pred_png_files = glob.glob(directory_path + '/57_DEM_rec_B.png') # 57_DEM_fake_B.png
    ...
    print('generated_images_resized shape: ', generated_images_resized[0].shape)
    print('ground_truth_images shape: ', generated_images_resized[0].shape)
